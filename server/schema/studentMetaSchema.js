...
exports.createStudentMetaSchema = [
    body('username')
        ...
        .isLength({ min: 3 })
        .withMessage('Username must contain at least 3 chars long')
        .trim().escape()
    ...
    body('state_province')
        .exists()
        .withMessage('You must specify your state or province')
        .isAlphanumeric()
        .withMessage('Your state or province field must contain only alphanumeric chars: letters and numbers')
        .trim().escape(),
    body('country')
        .exists()
...
exports.updateStudentMetaSchema = [
    ...
    body('sex')
        .optional()
        .isAlpha()
        .withMessage('Your gener field must contain only letters')
        .trim().escape(),
    body('nationality')
        .optional()
        .isAlpha()
