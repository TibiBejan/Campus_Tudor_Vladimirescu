...
exports.createEnrollmentSchema = [
    ...
    body('type_of_study')
        ...
        .isAlpha()
        .withMessage('Study type must contain only alphabetical chars')
        .trim().escape()
    ...
    body('financial_type')
        ...
        .isAlpha()
        .withMessage('Financial type must contain only alphabetical chars')
        .trim().escape()
    ...
    body('nationality')
        ...
        .isAlpha()
        .withMessage('Nationality must contain only alphabetical chars')
        .trim().escape()
     ...
     body('student_gender')
        ...
        .isAlpha()
        .withMessage('Gender must contain only alphabetical chars')
        .trim().escape()
