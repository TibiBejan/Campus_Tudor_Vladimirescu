                    ...
                    <ol className="information-accommodation-steps">
                        <li className="accommodation-step">
                            <p className="accommodation-step-label paragraph">
                                ...
                                <Link to={`/dashboard/${userState.user.first_name}.${userState.user.last_name}/information`} className="step-link">
                        ...
                        <li className="accommodation-step">
                            <p className="accommodation-step-label paragraph">
                                ...
                                <Link to={`/dashboard/${userState.user.first_name}.${userState.user.last_name}/kins`} className="step-link">
                        ...
                        <li className="accommodation-step">
                            <p className="accommodation-step-label paragraph">
                                ...
                                <Link to={`/dashboard/${userState.user.first_name}.${userState.user.last_name}/enrollment`} className="step-link">
